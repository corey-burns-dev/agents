...
export function normalizeClaudeCodeModelSlug(
...
export function requestKindFromToolName(
	toolName: string,
...
export function detailFromToolInput(
	toolName: string,
	input: unknown,
): string | undefined {
...
export function classifyClaudeCodeStderrLine(
	rawLine: string,
): { message: string } | null {
...
export function buildControlBlockResponse(
	requestId: string,
	reason?: string,
): string {
	return JSON.stringify({
